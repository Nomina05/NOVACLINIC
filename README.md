...
- Los trabajos de laboratorio completados pueden facturarse al doctor conservando el paciente asociado.
...
- Reporte de facturas POS/POST en formato ticket con empresa, cliente, factura, método, referencia, subtotal, IVA y total.
